...
_swigfaiss.FAISS_VERSION_MAJOR_swigconstant(_swigfaiss)
FAISS_VERSION_MAJOR = _swigfaiss.FAISS_VERSION_MAJOR

_swigfaiss.FAISS_VERSION_MINOR_swigconstant(_swigfaiss)
FAISS_VERSION_MINOR = _swigfaiss.FAISS_VERSION_MINOR

_swigfaiss.FAISS_VERSION_PATCH_swigconstant(_swigfaiss)
FAISS_VERSION_PATCH = _swigfaiss.FAISS_VERSION_PATCH

_swigfaiss.METRIC_INNER_PRODUCT_swigconstant(_swigfaiss)
METRIC_INNER_PRODUCT = _swigfaiss.METRIC_INNER_PRODUCT

_swigfaiss.METRIC_L2_swigconstant(_swigfaiss)
...
class HNSW(_object):
    ...
    __swig_getmethods__["shrink_neighbor_list"] = lambda x: _swigfaiss.HNSW_shrink_neighbor_list
    if _newclass:
